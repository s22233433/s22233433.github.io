...
assert.match(rootCareer, /action="\.\.\/api\/careers"/, "Career form uses the Cloudflare Pages Function endpoint.");
...
assert.match(rootCareer, /data\.delete\("resume_file"\)/, "Career form never uploads resume files through the form endpoint.");
